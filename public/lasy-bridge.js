...
(function setupLasyConsoleBridge() {
  ...
  // Ativar seletor de elementos (aguardar hidratação completa)
  function activateElementSelector() {
    ...
    if (document.readyState !== 'complete') {
      ...
      window.addEventListener('load', activateElementSelector, { once: true });
      return;
    }
  ...
  window.addEventListener('message', (event) => {
    // Só processar comandos se bridge estiver inicializado
